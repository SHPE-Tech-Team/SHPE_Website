    ...
    const resources = [
        {
            ...
            items: [
                ...
                {
                    name: "UIUC SHPE Constitution",
                    description: "The official constitution for the University of Illinois at Urbana-Champaign chapter of SHPE.",
                    url: "https://docs.google.com/document/d/1ipl7NZ_1JpdD1BW1g6NaIv7n08OAcBeRx68ZEhgFwzs/edit?tab=t.0",
                    icon: (
                        <svg className="w-8 h-8 text-shpe-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
                ...
                { 
                    name: "UIUC GenEd GPA Visualizer",
                    description: "Visualize your General Education GPA and progress towards graduation.",
                    url: "https://waf.cs.illinois.edu/discovery/every_gen_ed_at_uiuc_by_gpa/",
                    icon: (
                        <svg className="w-8 h-8 text-shpe-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h3a1.5,1.5,1,1,1,3,3v7.5" />
                        </svg>
                    )
                }
            ]
